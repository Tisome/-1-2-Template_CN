...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE          "lvgl_freertos_tick.h"      /* 系统时间函数头 */
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR    (xTaskGetTickCount() * portTICK_PERIOD_MS) /* 计算系统当前时间的表达式(以毫秒为单位) */
