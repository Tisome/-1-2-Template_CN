...
#elif defined(RCT6) || defined(CGT6)
...
#if defined(CGT6)
#define BOARD_DEFAULT_MEASURE_SOURCE APP_MEASURE_SOURCE_FAKE_DATA
#else
#define BOARD_DEFAULT_MEASURE_SOURCE APP_MEASURE_SOURCE_FPGA_SPI
#endif

#if defined(CGT6)
#undef APP_MEASURE_SOURCE
#define APP_MEASURE_SOURCE APP_MEASURE_SOURCE_FAKE_DATA
#elif !defined(APP_MEASURE_SOURCE)
#define APP_MEASURE_SOURCE BOARD_DEFAULT_MEASURE_SOURCE
#endif
