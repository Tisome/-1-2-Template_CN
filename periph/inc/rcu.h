...
#define RCU_GPIO_TFT_DC_PORT        RCU_GPIOB
#define RCU_GPIO_TFT_CS_PORT        RCU_GPIOA
#define RCU_GPIO_TFT_RESET_PORT     RCU_GPIOC
#define RCU_GPIO_TFT_SCK_PORT       RCU_GPIOB
#define RCU_GPIO_TFT_SDA_PORT       RCU_GPIOB
#define RCU_GPIO_TFT_BL_PORT        RCU_GPIOB
